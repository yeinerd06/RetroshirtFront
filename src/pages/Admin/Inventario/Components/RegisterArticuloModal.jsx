...
const RegisterArticuloModal = ({ open, handleOpen }) => {
    ...
    const { setArticulos, articulos, setLoading } = useUserContext();
    ...
    return (
        <Dialog open={open} handler={handleOpen} dismiss={{ outsidePress: false }}>
            <DialogHeader className="bg-blue-900 text-white">REGISTRAR PRODUCTO</DialogHeader>
            <form onSubmit={handleRegister}>
                <DialogBody divider style={{ maxHeight: "70vh", overflowY: "auto" }}>
                    ...
                    <div className="mb-4">
                        <Input label="Imagen" type="file" onChange={handleImageChange} required />
                    </div>
                    {imagen && (
                        <div className="mb-4">
